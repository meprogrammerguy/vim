...
# file generated by:  "curl wttr.in/:bash.function"
...
wttr() {
  ...
  #curl -fGsS -H "Accept-Language: ${LANG%_*}" $args --compressed "wttr.in/${location}?format=3"
  curl -fGsS -H "Accept-Language: ${LANG%_*}" $args --compressed "wttr.in/Alabaster?format=3"
}
